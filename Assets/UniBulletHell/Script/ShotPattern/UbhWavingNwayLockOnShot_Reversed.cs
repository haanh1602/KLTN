...
/// </summary>
[AddComponentMenu("UniBulletHell/Shot Pattern/Waving nWay Shot Reversed(Lock On)")]
public class UbhWavingNwayLockOnShot_Reversed : UbhWavingNwayShot_Reversed
{
    [Header("===== WavingNwayLockOnShot Reversed Settings =====")]
