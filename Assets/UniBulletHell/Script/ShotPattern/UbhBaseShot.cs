...
public abstract class UbhBaseShot : UbhMonoBehaviour
{
    ...
    public void ResetPointTarget(UbhBullet bullet,Transform target2,float m_speed,float m_homingAngleSpeed,float timeMove,float speedEnd,float speedAngleEnd)
    {
        bullet.ResetMtranform(target2,m_speed, m_homingAngleSpeed,timeMove,speedEnd,speedAngleEnd);
    }
   /* public void ResetTargetEndBullet(UbhBullet bullet, Transform target2, float m_speed, float m_homingAngleSpeed)
    {
        bullet.ResetMtranformEnd(target2, m_speed, m_homingAngleSpeed);
    }*/
}