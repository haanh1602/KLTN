...
public class UbhObjectPool : UbhSingletonMonoBehavior<UbhObjectPool>
{
    ...
    [SerializeField]
    public List<InitializePool> m_initializePoolList;
    ...
    protected override void Awake()
    {
        ...
        //try
        //{
        //Debug.LogError("Khai bao pool bullet: lam sau");
        /*
        PoolBulletPlaneManager poolBullet = FindObjectOfType<PoolBulletPlaneManager>();
        if (poolBullet != null)
            poolBullet.CheckPoolBulletPlane(m_initializePoolList);
